# Handoff — 17 августа 2026 (v1.6.5)
...
## Бой — стоп
Пользователь остановил правки боя: стало хуже. Не латать BattleScene/VFX/cinema точечно.
**Первая задача:** выполнить `BATTLE_REWORK_PROMPT.md` целиком (TODO P0). Контрактные события не менять.
...
5. Battle playback сейчас неприемлем. Реворк — главный приоритет.
