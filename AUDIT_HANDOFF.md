...
## Бой — стоп
Пользователь остановил правки боя: стало хуже. Не латать BattleScene/VFX/cinema точечно. Следующая работа по бою — **полный реворк** (TODO P0). Контрактные события не менять.
