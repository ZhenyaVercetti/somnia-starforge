...
Слой стоит: Three.js `BattleWorld` + Phaser HUD. Уникальные дроны, UV-facing, объёмный космос, тонкие выстрелы, `focusWinner` уже в коде. Cinema / top-down 2D / примитивные hulls / UV-на-бокс / ParticleEmitter — отклонены.
**Первая задача (TODO P0):** визуал **4/10 → 8/10**. Флот не должен быть кучей карточек. Строй без наложений, вид полноценного космического боя. Контрактные события не менять. Новый жанр не начинать.
...
5. Battle playback визуально не принят (4/10). P0 — строй без наложений и вид космического боя на текущем 3D-экране, не новый реворк.
