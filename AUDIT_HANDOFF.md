# Handoff — 20 августа 2026 (v1.6.5 + 3D battle layer)
...
## Live testnet (актуально 20.08.2026, адреса те же что 17.08)
...
## Бой — доработка текущего экрана
Слой уже стоит: Three.js `BattleWorld` (карточки hangar-портретов, флоты left/right) + Phaser HUD. Cinema / top-down 2D / примитивные hulls / UV-на-бокс / ParticleEmitter — отклонены и удалены. `BATTLE_REWORK_PROMPT.md` удалён.
**Первая задача (TODO P0):** довести **этот** экран до приёмки — посадка в кадр, взгляд на противника, тихий космос без полосы и планеты, Swarm как рой, живой idle, читаемые выстрелы. Контрактные события не менять. Новый жанр не начинать.
...
5. Battle playback визуально не принят. P0 — полировка текущего 3D-экрана, не новый реворк.
