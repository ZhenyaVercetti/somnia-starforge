...
**Статус:** v1.5 — **полностью завершён**  
**Дата:** 29 апреля 2026  
**Текущая версия в работе:** v1.6
...
**v1.6 (текущая цель)**  
- Отдельная сцена **CollectionScene** с фильтрами (rarity, фракция, класс, equipped/unequipped)  
- Анти-абуз минтинга: daily limit 10 buyUnit + +1 бесплатный корабль за level-up  
- Полная визуальная полировка (фон «Echo of Dreams», спрайты, анимации, tooltips)
...
**v1.8 — Расширение лора и атмосфера**  
